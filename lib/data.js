...
export const profile = {
    ...
    logo: '/images/footprint.png',
    introBanner: 'Welcome to my website',
    summary:
...
containerization tools.`,
    ...
    links: [
        { label: 'LinkedIn', handle: 'erendalcik', href: 'https://www.linkedin.com/in/erendalcik/' },
        { label: 'GitHub', handle: 'ferend', href: 'https://github.com/ferend' },
        { label: 'Twitter', handle: 'erendalcik', href: 'https://twitter.com/erendalcik' }
    ],

    bio: [
        { year: '1999', text: 'Born in Tekirdag, Turkey' },
        { year: '2021', text: "Graduated from Bachelor's Degree, Business Informatics" },
...
export const works = [
    ...
    },
    {
        ...
        href: 'https://drive.google.com/file/d/1Ln3z5pyUixX07YJh9TtvNaVIiWVo3rVR/view',
        image: '/images/works/bubble3d.png'
    },
    {
        title: 'Stray Brothers 3D',
        href: '', // replace if you have a link
        image: '/images/works/stray.png'
    },
    {
        title: 'Viennalife',
