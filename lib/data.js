...
export const profile = {
    ...
    title: 'Software Developer, IT Infrastructure Management Specialist',
...
system and infrastructure administration with hands-on experience across the full development and deployment lifecycle. 
As a Software Developer, I specialize in creating scalable backend services,
...
containerization tools.`,
    ...
    bio: [
        ...
        { year: 'Currently', text: 'Software & Infrastructure Senior Specialist ', href: 'https://viennalife.com.tr/' }
    ],

    certifications: [
        {
            text: 'Oracle Cloud Infrastructure Foundations',
            href: 'https://www.coursera.org/account/accomplishments/verify/K1BNOUN3T6S8'
        },
        {
...
export const webButtons = [
    { label: 'GITHUB / ferend', href: 'https://github.com/ferend' },
    { label: 'TWITTER / @erendalcik', href: 'https://twitter.com/erendalcik' },
    { label: 'LINKEDIN / erendalcik', href: 'https://www.linkedin.com/in/erendalcik/' },
    { label: 'SOURCE / this site', href: 'https://github.com/ferend/nextjs-chakra-framer-motion-portfolio' },
]
